...
class App extends Component {
  ...
  resetCount(e) {
    this.setState((prevState, props) => ({
      count:0,
      remember: this.state.count
    }));
  }

  restoreCount(e) {
    this.setState( (prevState,props) => ({
      count: this.state.remember
    }));
  }

  restoreCountAndAdd(e) {
    this.setState( (prevState,props) => ({
      count: this.state.remember + this.state.count
    }));
  }
  ...
  render() {
    return (
      <div className="App">
        ...
        <button onClick={this.incrementCountThree.bind(this)}>"Right Right Right"</button>
        ...
        <button onClick={this.restoreCountAndAdd.bind(this)}>Restore and Add</button>
      </div>
    );
  }
}
